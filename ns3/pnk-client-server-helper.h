 ...
 */
#ifndef PNK_CLIENT_SERVER_HELPER_H
#define PNK_CLIENT_SERVER_HELPER_H
 ...
 */
class PnkServerHelper
{
  public:
    /**
     * Create PnkServerHelper which will make life easier for people trying
 ...
 *
 */
class PnkClientHelper
{
  public:
    /**
     * Create PnkClientHelper which will make life easier for people trying
    ...
    PnkClientHelper(Address ip, uint16_t port);
    /**
     *  Create PnkClientHelper which will make life easier for people trying
     * to set up simulations with udp-client-server. Use this variant with
...
/**
 * \ingroup PnkClientserver
 * Create PnkTraceClient application which sends UDP packets based on a trace
 ...
 */
class PnkTraceClientHelper
{
  public:
    /**
     * Create PnkTraceClientHelper which will make life easier for people trying
     * to set up simulations with udp-client-server.
     *
     */
    PnkTraceClientHelper();
     ...
     */
    PnkTraceClientHelper(Address ip, uint16_t port, std::string filename);
    /**
     * Create PnkTraceClientHelper which will make life easier for people trying
     * to set up simulations with udp-client-server. Use this variant with
     * addresses that do include a port value (e.g., InetSocketAddress and
     ...
     * \param filename the file from which packet traces will be loaded
     */
    PnkTraceClientHelper(Address addr, std::string filename);

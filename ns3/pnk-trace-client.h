...
#ifndef PNK_TRACE_CLIENT_H
#define PNK_TRACE_CLIENT_H
 ...
 */
class PnkTraceClient : public Application
{
  public:
    /**
     ...
     *
     */
    PnkTraceClient(Ipv4Address ip, uint16_t port, char* traceFile);
    ~PnkTraceClient() override;

...
NS_LOG_COMPONENT_DEFINE("PnkTraceClient");

NS_OBJECT_ENSURE_REGISTERED(PnkTraceClient);

/**
 * \brief Default trace to send
 */
struct PnkTraceClient::TraceEntry PnkTraceClient::g_defaultEntries[] = {
    {0, 534, 'I'},
    {40, 1542, 'P'},
    {120, 134, 'B'},
    {80, 390, 'B'},
...
TypeId
PnkTraceClient::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::PnkTraceClient")
            .SetParent<Application>()
            .SetGroupName("Applications")
            .AddConstructor<PnkTraceClient>()
            .AddAttribute("RemoteAddress",
                          "The destination Address of the outbound packets",
                          AddressValue(),
                          MakeAddressAccessor(&PnkTraceClient::m_peerAddress),
                          MakeAddressChecker())
            .AddAttribute("RemotePort",
                          "The destination port of the outbound packets",
                          UintegerValue(100),
                          MakeUintegerAccessor(&PnkTraceClient::m_peerPort),
                          MakeUintegerChecker<uint16_t>())
            .AddAttribute("MaxPacketSize",
                          "The maximum size of a packet (including the SeqTsHeader, 12 bytes).",
                          UintegerValue(1024),
                          MakeUintegerAccessor(&PnkTraceClient::m_maxPacketSize),
                          MakeUintegerChecker<uint32_t>())
            .AddAttribute("TraceFilename",
                          "Name of file to load a trace from. By default, uses a hardcoded trace.",
                          StringValue(""),
                          MakeStringAccessor(&PnkTraceClient::SetTraceFile),
                          MakeStringChecker())
            .AddAttribute("TraceLoop",
                          "Loops through the trace file, starting again once it is over.",
                          BooleanValue(true),
                          MakeBooleanAccessor(&PnkTraceClient::SetTraceLoop),
                          MakeBooleanChecker())
...
PnkTraceClient::PnkTraceClient(Ipv4Address ip, uint16_t port, char* traceFile)
{
    NS_LOG_FUNCTION(this);
    m_sent = 0;
    m_socket = nullptr;
...
void
PnkTraceClient::SetRemote(Address ip, uint16_t port)
{
...
void
PnkTraceClient::SetRemote(Address addr)
{
...
void
PnkTraceClient::SetTraceFile(std::string traceFile)
{
...
void
PnkTraceClient::SetMaxPacketSize(uint16_t maxPacketSize)
{
...
uint16_t
PnkTraceClient::GetMaxPacketSize()
{
    NS_LOG_FUNCTION(this);
...
void
PnkTraceClient::LoadTrace(std::string filename)
{
...
void
PnkTraceClient::LoadDefaultTrace()
{
    NS_LOG_FUNCTION(this);
    uint32_t prevTime = 0;
...
void
PnkTraceClient::StartApplication()
{
    NS_LOG_FUNCTION(this);
    ...
    m_sendEvent = Simulator::Schedule(Seconds(0.0), &PnkTraceClient::Send, this);
}

void
PnkTraceClient::StopApplication()
{
    NS_LOG_FUNCTION(this);
...
void
PnkTraceClient::SendPacket(uint32_t size)
{
...
PnkTraceClient::Send()
{
    ...
    {
        m_sendEvent =
            Simulator::Schedule(MilliSeconds(entry->timeToSend), &PnkTraceClient::Send, this);
    }
}

void
PnkTraceClient::SetTraceLoop(bool traceLoop)
{
